...
You can find the entire implementation in the [example source code](https://github.com/blastbao/watermill/tree/master/_examples/basic/5-cqrs-protobuf/?utm_source=cqrs_doc).
